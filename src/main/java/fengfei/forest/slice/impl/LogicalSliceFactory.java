    ...
    public <Source> LogicalSlice<Source> create(
        ...
        if (sliceKind == SliceKind.Physical) {
            ...
            case ReadWrite:
                ...
                break;
            case MasterSlave:
                logicalSlice = new MasterSlaveLogicalSlice<>();
                break;
            case Equality:
                logicalSlice = new EqualityLogicalSlice<>();
                break;
        ...
        logicalSlice.setSuffix(group.getUnitSuffix() + sliceConfig.getId());
    ...
    private <Source> void buildSliceConfig(
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (id == null || "".equals(id) || logicalSlice.getId().equals(id)) {
                ...
                physicalSlice.setId((pid == null || "".equals(pid)) ? String.valueOf(i) : (pid
                        + "_" + i));
            }
